               ...
               <main>
                    <section className="home-cl section-padding">
                        <section className="popular-location section-padding">
                            ...
                            <div className="title justify-content-center mt-5">Top Categories</div>
                            <div className="top-categories_list row">                            
                                            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 top-categories_item"  
                                            data-aos="flip-left"
                                            ...
                                            data-aos-duration="2000">
                                                ...
                                                <div className="top-categories_item_detail">
                                                    ...
                                                    <h6 className="mt-2" style={{fontSize: "20px"}}>Viva flower</h6>
                            ...
                            <div className="top-categories">
                            <div className="title justify-content-center mt-5">Featured Products</div>
                            <div className="categories-list d-flex justify-content-between col-6 offset-3">
                                <div className={activeIndex === 0 ? "active" : ""}
                                       onClick={() => handleClick(0)}>Product Name</div>
                                <div className={activeIndex === 1 ? "active" : ""}
                                      onClick={() => handleClick(1)}>Product Name</div>
                                <div className={activeIndex === 2 ? "active" : ""}
                                      onClick={() => handleClick(2)}>Product Name</div>
                                <div className={activeIndex === 3 ? "active" : ""}
                                      onClick={() => handleClick(3)}>Product Name</div>
                            </div>
                            {activeIndex === 0 && (
                            <div className="top-categories_list row">                            
