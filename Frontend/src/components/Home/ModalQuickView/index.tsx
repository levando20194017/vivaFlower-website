    ...
    <ModalBody>
        <div className='modal-quick-view row'>
           ...
           <div className="col-6 item-detail">
            ...
            <div><b>Price:</b> <b style={{color: "red"}}>229.000đ</b></div>
            <hr/>
            <div className="text-secondary" style={{fontSize: "13px"}}><b style={{color: "black"}}>Note:</b> Customer have to pay shipping fees <b style={{color: "black"}}>5.000đ</b> for <b style={{color: "black"}}>1 km</b>.</div>
            <div className="mt-4 d-flex justify-content-between">
                <div className="d-flex quantity"><span>Qty</span><input type="number" className="form-control"/></div>
                <div className="button-add ">
                    <button> <i className="bi bi-cart4"></i> Add to cart</button>
                 </div>
                <div className="buy-now">
                    <button><i className="bi bi-bag-heart-fill"></i> Buy now</button>
                </div>
            </div>
           </div>
        </div>
